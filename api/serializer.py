...
from .models import Category, Discount, ProductItem, Producer, Promocode, RegistredUser,Order,Cashback,Comment
...
class ProductItemSerializer(ModelSerializer):
    ...
    class Meta:
        model = ProductItem
        fields = ['id', 'name', 'description', 'producer', 'category', 'discount', 'price', 'articul', 'count_on_stock','Product_text','Product_Item']
...
class RegistrarionSerializer(ModelSerializer):
    ...
    class Meta:
        model = RegistredUser
        fields = ['age','phone','email','password','login','token']
...
class LoginSerializer(serializers.Serializer):
    ...
    def validate(self,data):
        ...
        user = RegistredUser.objects.filter(phone=phone)
...
class OrderSerializer(serializers.ModelSerializer):
    ...
    def calculate_result_price(self, data):
        ...
        add_cashback_point = result_price * (cashback.percent / 100)
