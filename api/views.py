...
from .serializer import CategorySerializer,ProducerSerializer,PromocodeSerializer,ProductItemSerializer,DiscountSerializer,RegistrarionSerializer,LoginSerializer,BasketSerializer,AddProductSerializer,DeleteProductSerializer,OrderSerializer,ProductItemDetailSerializer
...
class ProductItemListView(ListAPIView):
    queryset = ProductItem.objects.all().values('id', 'name', 'description', 'producer', 'category', 'discount', 'price', 'articul', 'count_on_stock')
...
class BasketView(APIView):
    ...
    def post(self,request):
        ...
        return Response("Not enough product of stock",status=409)
